...
// get_timer() is in ticks at half clock speed 200Mticks/sec @400MHz
// so 1ms = 200kticks
// change timeout for non-bulk devices to 100ms to get faster resets
// in case of broken SETUP packet 
#define USB_TIMEOUT_MS(pipe) (usb_pipebulk(pipe) ? 5000 * 200000 : 100 * 200000)
